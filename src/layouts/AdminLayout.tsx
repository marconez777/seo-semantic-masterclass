...
import { ClipboardList, Upload, Settings, PenTool, Users, FileText, MessageSquare, Gift, Globe, Briefcase, Video, BarChart3, GraduationCap } from "lucide-react";
...
export default function AdminLayout() {
  ...
  const adminMenuItems = [
    ...
    { title: "Aula Médico", url: "/admin/aula", icon: GraduationCap },
