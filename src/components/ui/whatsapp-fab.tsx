...
export function WhatsAppFAB() {
  ...
  // Hide on admin pages, aula-medico, webinar-medico, diagnostico, or when cart modal is open
  if (pathname.startsWith("/admin") || pathname.startsWith("/aula-medico") || pathname.startsWith("/webinar-medico") || pathname.startsWith("/diagnostico") || cartOpen) return null
    ...
    >
      <div className="flex items-center gap-3 px-3 py-8">
        ...
        <div className="text-left">
          <div className="text-xs font-normal leading-tight">FALE AGORA POR</div>
          <div className="text-lg font-bold leading-tight">WhatsApp</div>
        </div>
      </div>
    </FAB>
  )
