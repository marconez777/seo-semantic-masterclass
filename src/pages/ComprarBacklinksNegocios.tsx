...
export default function ComprarBacklinksNegocios() {
  ...
  const filtered = useMemo(() => {
    ...
    return (backlinks ?? []).filter((b) => {
      // Restrito a Negócios/Empreendedorismo
      const cat = normalize(String(b.category ?? ""));
      if (!(cat === "negocios")) return false;
  ...
  return (
    <>
      ...
      <StructuredData
        ...
        data={{
          items: [
            ...
            {
              name: "Comprar Backlinks de Negócios",
              url: `${window.location.origin}/comprar-backlinks-negocios`,
            },
          ],
        }}
      />
      <CategoryStructuredData
        ...
        backlinks={filtered}
        description="Compre backlinks de qualidade em blogs e portais de empreendedorismo e negócios. Links com alta autoridade para melhorar seu SEO."
      />
      <Header />
      <main className="container mx-auto px-4 py-28">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <section className={isMobile ? "col-span-1" : "md:col-span-10"}>
            ...
            items={[
              { name: "Início", url: "/" },
              { name: "Backlinks de Negócios", url: "/comprar-backlinks-negocios" },
            ]}
          />
          <h1 className="text-4xl font-bold mb-6">
            Backlinks de Qualidade em Portais de Empreendedorismo
          </h1>
          ...
          <section className="mt-10">
            <h2 className="text-2xl font-semibold mb-2">Os Melhores Backlinks para o seu Site</h2>
