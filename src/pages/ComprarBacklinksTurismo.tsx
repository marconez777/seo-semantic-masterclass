  ...
  return (
    <>
      ...
      <StructuredData
        ...
        data={{
          items: [
            ...
            {
              name: "Backlinks de Turismo",
              url: `${window.location.origin}/comprar-backlinks-turismo`,
            },
          ],
        }}
      />
      <CategoryStructuredData
        ...
        backlinks={filtered}
        description="Compre backlinks de qualidade em blogs e portais de turismo e viagens. Links com alta autoridade para melhorar seu SEO."
      />
      <Header />
      <main className="container mx-auto px-4 py-28">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <section className={isMobile ? "col-span-1" : "md:col-span-10"}>
            ...
            items={[
              { name: "Início", url: "/" },
              { name: "Backlinks de Turismo", url: "/comprar-backlinks-turismo" },
            ]}
          />
          <h1 className="text-4xl font-bold mb-6">Backlinks no Nicho de Turismo</h1>
          ...
          <section className="mt-10">
            <h2 className="text-2xl font-semibold mb-2">Compre Backlinks de Qualidade para o Nicho de Viagens e Turismo</h2>
