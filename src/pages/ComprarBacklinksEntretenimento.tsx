...
export default function ComprarBacklinksEntretenimento() {
  ...
  const filtered = useMemo(() => {
    ...
    return (backlinks ?? []).filter((b) => {
      // Restrito a Entretenimento
      const cat = normalize(String(b.category ?? ""));
      if (!(cat === "entretenimento")) return false;
      ...
      <main className="container mx-auto px-4 py-28 grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <section className="md:col-span-10">
          <Breadcrumbs
            ...
            items={[
              { name: "Início", url: "/" },
              { name: "Backlinks de Entretenimento", url: "/comprar-backlinks-entretenimento" },
            ]}
          />
          <h1 className="text-4xl font-bold mb-4">Backlinks no Nicho de Entretenimento</h1>
          <div className="mb-6">
          ...
          <section className="mt-10">
            <h2 className="text-2xl font-semibold mb-2">
              Como escolher os melhores backlinks para o seu site de Entretenimento
            </h2>
            <p className="text-muted-foreground">
              Texto SEO com dicas e melhores práticas para escolher backlinks no nicho de entretenimento. Foque em relevância temática, autoridade do domínio, perfil de tráfego e naturalidade do link building.
            </p>
          </section>
        </section>
      </main>
