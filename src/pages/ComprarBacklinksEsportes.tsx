  ...
  return (
    <>
      ...
      <StructuredData
        ...
        data={{
          items: [
            ...
            {
              name: "Backlinks de Esportes",
              url: `${window.location.origin}/comprar-backlinks-esportes`,
            },
          ],
        }}
      />
      <CategoryStructuredData
        ...
        backlinks={filtered}
        description="Compre backlinks de qualidade em blogs e portais esportivos. Links com alta autoridade para melhorar seu SEO."
      />
      <Header />
      <main className="container mx-auto px-4 py-28 grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <section className="md:col-span-10">
          <Breadcrumbs
            ...
            items={[
              { name: "Início", url: "/" },
              { name: "Backlinks de Esportes", url: "/comprar-backlinks-esportes" },
            ]}
          />
          <h1 className="text-4xl font-bold mb-4">Backlinks no Nicho de Esportes</h1>
          <div className="mb-6">
            <h2 className="text-2xl font-semibold mb-2">Compre Backlinks de Qualidade para o Futebol e Esportes</h2>
          ...
          <section className="mt-10">
            <h2 className="text-2xl font-semibold mb-2">
              Como escolher os melhores backlinks para o seu site de Esportes
            </h2>
            <p className="text-muted-foreground">
              Texto SEO com dicas e melhores práticas para escolher backlinks no nicho esportivo. Foque em relevância temática, autoridade do domínio, perfil de tráfego e naturalidade do link building.
            </p>
          </section>
        </section>
      </main>
