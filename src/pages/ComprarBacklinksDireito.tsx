  ...
  return (
    <>
      <SEOHead
        ...
        canonicalUrl={`${SITE_URL}/comprar-backlinks-direito`}
      ...
      <StructuredData
        ...
        data={{
          items: [
            ...
            {
              name: "Backlinks de Direito",
              url: `${SITE_URL}/comprar-backlinks-direito`,
            },
          ],
        }}
      />
        ...
        <section className="md:col-span-10">
          ...
          <div className="mb-6">
            <h2 className="text-2xl font-semibold mb-2">
              Compre Backlinks de Qualidade para o nicho de Justiça e Direito
            </h2>
              ...
              <thead className="bg-accent/40">
                <tr className="text-left">
                  <th
                    ...
                    tabIndex={0}
                    onClick={() => {
                      if (sortKey === "site_name") setSortDir(sortDir === "asc" ? "desc" : "asc");
                      else {
                  ...
                  <th
                    ...
                    tabIndex={0}
                    onClick={() => {
                      if (sortKey === "dr") setSortDir(sortDir === "asc" ? "desc" : "asc");
                      else {
                        setSortKey("dr");
                        setSortDir("desc");
                      }
                  ...
                  <th
                    ...
                    tabIndex={0}
                    onClick={() => {
                      if (sortKey === "da") setSortDir(sortDir === "asc" ? "desc" : "asc");
                      else {
                        setSortKey("da");
                        setSortDir("desc");
                      }
                  ...
                  <th
                    ...
                    tabIndex={0}
                    onClick={() => {
                      if (sortKey === "traffic") setSortDir(sortDir === "asc" ? "desc" : "asc");
                      else {
                        setSortKey("traffic");
                        setSortDir("desc");
                      }
                  ...
                  <th
                    ...
                    tabIndex={0}
                    onClick={() => {
                      if (sortKey === "price_cents") setSortDir(sortDir === "asc" ? "desc" : "asc");
                      else {
          ...
          <div className="flex items-center justify-between mt-4">
            <div className="text-sm text-muted-foreground">
              Página {currentPage} de {pageCount} — {sorted.length} itens
            </div>
            <div className="flex items-center gap-2">
              ...
              <select
                className="ml-2 border rounded-md px-2 py-1 bg-background"
                value={itemsPerPage}
