      ...
      <StructuredData
        ...
        data={{
          items: [
            ...
            {
              name: "Comprar Backlinks de Educação",
              url: `${window.location.origin}/comprar-backlinks-educacao`,
            },
          ],
        }}
      />
      ...
      <main className="container mx-auto px-4 py-28 grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <section className="md:col-span-10">
          <Breadcrumbs
            ...
            items={[
              { name: "Início", url: "/" },
              { name: "Backlinks de Educação", url: "/comprar-backlinks-educacao" },
            ]}
          />
          <h1 className="text-4xl font-bold mb-6">
            Backlinks de Qualidade em Portais de Educação
          </h1>
